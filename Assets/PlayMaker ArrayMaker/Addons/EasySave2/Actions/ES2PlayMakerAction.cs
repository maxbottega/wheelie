...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class UploadQuaternion : FsmStateAction
	{
		...
		public override void Reset()
		{
			uniqueTag = "";
			saveFile = "defaultES2File.txt";
			saveValue.Value = Quaternion.identity;
			urlToPHPFile = "http://www.mysite.com/ES2.php";
			web = null;
			errorMessage = "";
			errorCode = "";
	...
	public class DownloadQuaternion : FsmStateAction
	{
		...
		public override void Reset()
		{
			uniqueTag = "";
			saveFile = "defaultES2File.txt";
			loadValue.Value = Quaternion.identity;
			urlToPHPFile = "http://www.mysite.com/ES2.php";
			web = null;
			errorMessage = "";
			errorCode = "";
